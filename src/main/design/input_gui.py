...
class ConnectFourSetup:
    def __init__(self):
        ...
        user_vs_comp_button = tk.Button(button_frame, text="🧑 vs 💻", font=("Helvetica", 22), command=self.start_user_vs_comp_game, width=15, height=3, bg="yellow")        
    ...
    def start_user_vs_comp_game(self):
        grid_size = self.grid_size_var.get()
        row_count, column_count = map(int, grid_size.split("x"))
        print(f"Grid Size: {grid_size}")
        #root = tk.Tk()

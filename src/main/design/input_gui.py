...
class ConnectFourSetup:
    def __init__(self):
        ...
        user_vs_comp_button = tk.Button(button_frame, text="🧑 vs 💻", font=("Helvetica", 22), command=self.start_user_vs_comp_popup, width=15, height=3, bg="yellow")        user_vs_comp_button.pack(side="left", padx=10)
